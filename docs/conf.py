...
# -*- coding: utf-8 -*-
#
# jupyterlab_celltests documentation build configuration file, created by
...
htmlhelp_basename = 'jupyterlab_celltestsdoc'
...
latex_documents = [
    (master_doc, 'jupyterlab_celltests.tex', 'jupyterlab_celltests Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'jupyterlab_celltests', 'jupyterlab_celltests Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jupyterlab_celltests', 'jupyterlab_celltests Documentation',
     author, 'jupyterlab_celltests', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    jupyterlab_celltests_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'jupyterlab_celltests'))
